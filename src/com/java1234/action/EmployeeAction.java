...
public class EmployeeAction extends ActionSupport {
	...
	public void ExportEmployee() throws Exception {
		...
		try {
			...
			String[] cellTitle = { "ID", "编号", "姓名", "性别", "出生日期", "民族", "学历", "专业", "部门", "职务", "基本工资", "加班费", "工龄工资",
					"考勤费", "旷工费", "保险费" };
		...
		ServletActionContext.getResponse().setHeader("Content-Disposition",
				"attachment;filename=" + new String((exportFileName).getBytes(), "ISO8859-1"));// 设定输出文件头
	...
	public String userNameComboList() throws Exception {
		...
		try {
			...
			jsonArray.addAll(JsonUtil.formatRsToJsonArray(employeeDao.employeeList(con, null, null, "", "")));
